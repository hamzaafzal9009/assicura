            ...
            <div class="py-4 border-bottom">
                <div class="media">
                    <div class="align-self-center me-3">
                        <img src="{{ URL::asset('/assets/images/logo.png') }}" class="avatar-xs rounded-circle" alt="">
                    </div>
                    <div class="media-body">
                        <h5 class="font-size-15 mt-0 mb-1">
                            {{ Auth::check() ? Str::ucfirst(Auth::user()->name) : 'John Doe' }}</h5>
                        <p class="text-muted mb-0">
                            @if (Auth::user()->is_active == 1)
                            <i class="mdi mdi-circle text-success align-middle me-1"></i> Active
                            @else
                            <i class="mdi mdi-circle text-danger align-middle me-1"></i> Offline
                            @endif
                        </p>
                    </div>
                </div>
